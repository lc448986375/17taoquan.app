var base_url = 'https://17taoquan.wang/';
...
// 参考http://www.cnblogs.com/wolf-sun/p/6878868.html
...
app.controller('DetailCtrl', function($scope, $state, $stateParams, $ionicPopup, $ionicPopover, http_service, msg) {
    ...
    function showTkl(tkl) {
        ...
        confirmPopup.then(function(res) {
            if(res) {
                console_log('You are sure');
            } else {
                console_log('You are not sure');
            }
        });
    }
